...
// This declares that there the require fuction is declared somewhere in javascript.
// This way we can import from node
external fun require(module:String):dynamic

@JsModule("jsBridge")
class Bridge () {

    internal const TIMEOUT_CYCLES = 100
    internal const TIMEOUT_TIME = 10

    //TODO: Implement own version of Renderer because backend needs it. Maybe just empty implementations.
    //TODO: evaluate what to do with VirtualFileSystem(VFS)

    //val router = require("http")
    ...
    //val LS = LocalStorage() //TODO: do we need this?
    var useLS = false
    private var saveInterval: Int? = null
    var p = ""
    private var ready = false
    @JsName("FReginputAsFloat") var FReginputAsFloat = true
    //@JsName("ScriptManager") var ScriptManager = venus.api.ScriptManager //TODO: DO we need this?
    ...
    init {
        ...
        simState64.getReg(0)
        //TODO: Do we even need our own Linting?
        Linter.lint("")
    ...
    //TODO: Understand what this function does and maybe rewrite it from scratch
    // It seems this is the entry point for assembling a programm.
    @JsName("assembleSimulator") fun assembleSimulator(sourceCodeText: String) {
        var text = getText()
        if (text == "") {
    ...
    internal fun assemble(text: String, name: String = "", absPath: String): Program? {
        ...
        if (errors.isNotEmpty()) {
            //TODO: Provide a alternative to displaying errors
    ...
    //TODO: Maybe use this fuction instead of assembleSimulator?
